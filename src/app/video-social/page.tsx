    ...
    <PhotoLayout>
      ...
      <div className="flex justify-center">
        ...
        >
          {p.thumbnail && (
            <>
              <Image src={p.thumbnail} alt="Anteprima video Instagram" fill className="object-cover object-center" />
          ...
          <p className="relative z-10 text-white/80 text-xs text-center">{p.instagramHandle}</p>
        </a>
      </div>
    </PhotoLayout>
  )
